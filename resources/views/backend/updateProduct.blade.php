...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <form id="createForm" method="POST" action="{{url('admin/products/update')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" id="harddrive" name="harddrive" value="{{$product->harddrive}}">
                            <div class="invalid-feedback" id="errorHardDrive">
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="card" class="col-form-label"><h6>Card đồ họa:</h6></label>
                            <input type="text" class="form-control" id="card" name="card" value="{{$product->card}}">
                    ...
                    <div style="text-align: right">
                        <button class="btn btn-primary" type="button" id="buttonUpdate">Cập nhật</button>
