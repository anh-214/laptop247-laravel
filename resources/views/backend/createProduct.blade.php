...
<section class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1>Thêm sản phẩm cho thể loại {{$category->name}}</h1>
        </div>
        <div class="col-sm-6">
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <form id="createForm" method="POST" action="{{url('admin/categories/'.$category->id.'/createproduct')}}" enctype="multipart/form-data">
                    @csrf
